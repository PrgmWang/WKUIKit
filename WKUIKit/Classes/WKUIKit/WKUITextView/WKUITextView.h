...
@protocol WKUITextViewDelegate <UITextViewDelegate>
 ...
 */
- (void)textView:(WKUITextView *)textView newHeightAfterTextChanged:(CGFloat)height;
 ...
 */
- (BOOL)textViewShouldReturn:(WKUITextView *)textView;
 ...
 */
- (void)textView:(WKUITextView *)textView didPreventTextChangeInRange:(NSRange)range replacementText:(NSString *)replacementText;
 ...
 */
@interface WKUITextView : UITextView

@property(nonatomic, weak) id<WKUITextViewDelegate> delegate;
/**
