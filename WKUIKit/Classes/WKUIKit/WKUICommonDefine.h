...
#ifndef WKUICommonDefine_h
#define WKUICommonDefine_h
...
//底部安全区高度
#define kSafeAreaBottomHeight (kISiPhoneXX ? 34 : 0)

#pragma mark ---------------- 字体宏 ----------------
//正常字体 normal 苹方
#define kNormalFont(x)  [UIFont systemFontOfSize:x]
//粗体
