...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/PrgmWang/WKUIKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'PrgmWang' => 'wang.kai@jnetdata.com' }
  s.source           = { :git => 'https://github.com/PrgmWang/WKUIKit.git', :tag => s.version.to_s }
